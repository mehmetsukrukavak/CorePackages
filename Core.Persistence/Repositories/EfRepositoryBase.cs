    ...
    where TContext : DbContext
{
    ...
    public async Task<TEntity> AddAsync(TEntity entity)
    {
        ...
        entity.ModifiedUserId = entity.CreatedUserId;
        entity.StatusId = Status.Valid;
    ...
    {
        if (entity.StatusId == Status.Invalid)
            return;
        entity.ModifiedDate = DateTime.UtcNow;
        entity.StatusId = Status.Invalid;
    ...
    protected IQueryable<object> GetRelationLoaderQuery(IQueryable query, Type navigationPropertyType)
    {
        ...
        return queryProviderQuery.Where(x => ((IEntity)x).StatusId == Status.Invalid);
    }
